...
# Form implementation generated from reading ui file 'C:\Users\jumen\Documents\Codes\python\eventcreator\criarEvento.ui'
#
...
class Ui_CriarEvento(object):
    def setupUi(self, CriarEvento):
        CriarEvento.setObjectName("CriarEvento")
        CriarEvento.resize(550, 538)
        CriarEvento.setMaximumSize(QtCore.QSize(550, 16777215))
        CriarEvento.setStyleSheet("background-image: url(:/Background/D:/Dowloards/WhatsApp Image 2021-12-01 at 13.24.01.jpeg);")
...
"}")
    ...
    def retranslateUi(self, CriarEvento):
        ...
        item.setText(_translate("CriarEvento", "Claudete Leite"))
        item = self.tableWidgetCE.item(0, 1)
        item.setText(_translate("CriarEvento", "PIUPIU AMARELINHO"))
...
if __name__ == "__main__":
    ...
    CriarEvento = QtWidgets.QMainWindow()
    ui = Ui_CriarEvento()
    ui.setupUi(CriarEvento)
    CriarEvento.show()
    sys.exit(app.exec_())
